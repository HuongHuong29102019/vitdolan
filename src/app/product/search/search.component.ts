...
export class SearchComponent extends BaseComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this._route.params.subscribe(params => {
      ...
      this._api.post('/api/item/searchnamehome', { page: this.page, pageSize: this.pageSize, item_name: this.item_name}).takeUntil(this.unsubscribe).subscribe(res => {
        this.list = res.data;
  ...
  loadPage(page) { 
    this._route.params.subscribe(params => {
      let id = params['id'];
      this._api.post('/api/item/searchnamehome', { page: page, pageSize: this.pageSize, item_name: id}).takeUntil(this.unsubscribe).subscribe(res => {
        this.list = res.data;
        this.totalItems = res.totalItems;
        }, err => { });       
   });   
